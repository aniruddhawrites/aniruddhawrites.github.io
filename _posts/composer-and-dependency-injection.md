...
subtitle:  We are working with composer almost from the same time, when Symfony 2 released. Though this package manager evolves with its own signature describing the very popular Design Pattern "Dependency Injection". Today most of the PHP frameworks uses it. Let me explain some interesting facts about composer.
cover-img: /assets/img/composer-and-dependency-injection.png
thumbnail-img: /assets/img/composer-and-dependency-injection.png
share-img: /assets/img/composer-and-dependency-injection.png
